...
Supports two modes:
  1. LLM mode - if ANTHROPIC_API_KEY or OPENAI_API_KEY is set in the
     environment, calls that provider with a strict grounding prompt.
  2. Extractive fallback - if no API key is set, returns the most relevant
